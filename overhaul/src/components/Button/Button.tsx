...
const ButtonContainer = styled.div`
    ...
    --button-font-family: ${p => p.theme.fonts.serif};
    --button-font-color: ${p => p.theme.colors.invTintBackground};
    --button-font-color-hover: ${p => p.theme.colors.primary};
    ...
    --button-primary-color: ${p => p.theme.colors.invTintBackground};
    --button-primary-color-dark: ${p => p.theme.colors.grey};
    --button-primary-color-light: ${p => p.theme.colors.background};
    --button-primary-color-hover: ${p => p.theme.colors.tintBackground};
    --button-primary-color-active: ${p => p.theme.colors.tintBackground};
