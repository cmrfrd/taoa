...
var createJsonURL = function createJsonURL(jsonName) {
  return "/cmrfrd.github.io" + "/static/d/" + jsonName + ".json";
};
...
var queue = {
  addPagesArray: function addPagesArray(newPages) {
    findPage = find_page(newPages, "/cmrfrd.github.io");
  },
  ...
  hovering: function hovering(rawPath) {
    var path = strip_prefix(rawPath, "/cmrfrd.github.io");
...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker.register("/cmrfrd.github.io" + "/sw.js").then(function (reg) {
...
Object(api_runner_browser["apiRunnerAsync"])("onClientEntry").then(function () {
  ...
  if (page && page.path !== "/404.html" && "/cmrfrd.github.io" + page.path !== browserLoc.pathname && !page.path.match(/^\/offline-plugin-app-shell-fallback\/?$/) && (!page.matchPath || !Object(utils["match"])("/cmrfrd.github.io" + page.matchPath, browserLoc.pathname))) {
    Object(es["navigate"])("/cmrfrd.github.io" + page.path + browserLoc.search + browserLoc.hash, {
      replace: true
    });
  }
...
//# sourceMappingURL=app-37355a63d53c69125759.js.map