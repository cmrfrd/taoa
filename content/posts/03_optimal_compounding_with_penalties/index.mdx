...
represented by time $t$ between compounds. This can be described as
follows:
...
point we can take ${\rm ciwip}\left(P, r, {f_{gas}}, n\right) = P$, and simply solve for
...
> concavity (from [theorem 3.5.6 of Anatoli Iouditski Convex Optimization course](https://www-ljk.imag.fr/membres/Anatoli.Iouditski/cours/convex/chapitre_3.pdf))
...
set of parameters, manual compounding via optimal $ciwip$ performs better
