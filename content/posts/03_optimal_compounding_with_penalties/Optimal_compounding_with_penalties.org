...
#+LAST_MODIFIED: [2021-11-13 Sat 23:26]
...
container-dir-str)]{print(latex(t))} between comounds. This can described as
follows:
...
concavity (from [[https://www-ljk.imag.fr/membres/Anatoli.Iouditski/cours/convex/chapitre_3.pdf][theorum 3.5.6 of Anatoli Iouditski Convex Optimization course]])
...
set of paramaters, manual compounding via optimal src_python[:results output
