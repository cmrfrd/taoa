...
Now not only is this cool, but there is a <span class="underline">real</span> personal use case I care about,
which is the ability to self host my side projects that <span class="underline">aren't</span> naturally web
based.
