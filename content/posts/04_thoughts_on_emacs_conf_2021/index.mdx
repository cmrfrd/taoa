...
secret: false
excerpt: "Emacs Makers Are Crazy Sickos"
---

## EmacsConf 2021

Every year, I like to watch [EmacsConf](https://emacsconf.org/2021/) not only to learn about the latest and
...
In [Emacs as Design Pattern Learning](https://emacsconf.org/2021/talks/pattern/), Greta Goetz goes very philosophical and
talks about Emacs in the context of self-education.

The first interesting point Goetz states is, with Emacs: _"we can be our own
persona."_
...
This is a mind bomb and reminded me of the ideas from the post ["Emacs is a
lifestyle"](https://batsov.com/articles/2021/11/24/emacs-is-a-lifestyle/][) by Bozhidar Batsov. Just like how Goetz describes the Emacs
...
In the short talk [Why Emacs demonstrates the UNIX philosophy isn't the only
answer](https://emacsconf.org/2021/talks/unix/), Daniel Rose talks about how Emacs fits within the UNIX philosophy. He
