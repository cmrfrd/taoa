...
```text
[[0.73449389 0.54895412 0.4318125  0.49579821]
 [0.64073733 0.53456924 0.4564287  0.45139246]]
```
...
```text
[0.31747906 0.67557869 0.63683977 0.78580511 0.80719429 1.16529391
 1.126555   1.27552034 1.21638136 1.57448099 1.53574208 1.68470742
 1.51774183 1.87584146 1.83710255 1.98606789]
(16,)
```
...
```text
[1.12258688 2.04320971 1.52755498 1.73536779]
(4,)
```
...
```text
[-1.70329184  0.86647688 -1.36582266  0.47069552 -1.20065069  1.19667966
  0.16447022 -0.46533094  0.02325212  3.52518688]
float64
```
...
$ /usr/local/lib/python3.11/site-packages/nodeenv.py:26: DeprecationWarning: 'pipes' is deprecated and slated for removal in Python 3.13
  import pipes
 * Install prebuilt node (19.8.1) ..... done.
...
Completed in 0.55sec
```

`pyright` is telling us we've incorrectly typed `cube` and that it's
