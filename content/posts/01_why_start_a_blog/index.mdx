...
I've been reading and learning from tech blogs by people like [Julia Evans](https://jvns.ca),
[Mike Bostock](https://bost.ocks.org/mike/), or [Vincent Warmerdam](https://koaning.io) for the past several years. They have
...
## The Art of Abstraction {#the-art-of-abstraction}

_"First you learn the value of abstraction, then you learn the cost of
abstraction, then you're ready to engineer."_ -- Kent Beck
...
## Drafting the right seed goals {#drafting-the-right-seed-goals}
...
1.  **Cultivate a digital garden**
    ...
    The concept of a _"Digital Garden"_ has an [interesting history](https://maggieappleton.com/garden-history) and is a
    very unique idea (see [this](https://www.technologyreview.com/2020/09/03/1007716/digital-gardens-let-you-cultivate-your-own-little-bit-of-the-internet/) or [this](https://joelhooks.com/digital-garden) for more).

    _"The phrase 'digital garden' is a metaphor for thinking about writing and
    creating that focuses less on the resulting 'showpiece' and more on the
    process, care, and craft it takes to get there."_

    Using the abstraction of the _"garden"_ in this analogy to describe this
...
2.  **Stock OVER flow**
    ...
    ([tomcritchlow](https://tomcritchlow.com/2019/02/17/building-digital-garden/) and [Robin Sloan](http://snarkmarket.com/2010/4890)) from which this goal has been appropriated.

    _"Flow is the feed. It’s the posts and the tweets. It’s the stream of daily
    and sub-daily updates that reminds people you exist._

    _Stock is the durable stuff. It’s the content you produce that’s as
    ...
    _Stock over flow_ imposes the opinion that the content creation process
    should prioritize the verbose and long lasting, over the immediate and
    short form _"status updates."_ I believe _"stock"_ content sticks in
    ...
    This goal is not meant to disregard _"flow"_ and maybe in the future **The
    Art of Abstraction** will produce _"flow"_ content. But in these early days
    it's time to establish a solid base and build _"stock."_
...
3.  **Show AND tell**
    ...
    Blog posts from places like [distill.pub](https://distill.pub/), [TensorFlow blog](https://blog.tensorflow.org/), or
    [fivethirtyeight](https://projects.fivethirtyeight.com/super-tuesday/) include interactive portions where users can literally
...
right giants to stand on, and the right [stack](https://en.wikipedia.org/wiki/Solution%5Fstack) for you.

After researching how sites were built in the past, then watching [lecture](https://www.youtube.com/watch?v=uWTMEDEPw8c)
after [lecture](https://www.youtube.com/watch?v=JCATu2WkOq8) after [lecture](https://www.youtube.com/watch?v=MZLS4cq7fRY) about how they are being built now, I'm
sufficently convinced of these new practices and am now a proponent of
subjectively "modern" web development. Reading the philosophy of the [JAM
stack](https://jamstack.wtf/), the [PRPL](https://web.dev/apply-instant-loading-with-prpl/) pattern, and learning about the utility of [static site
generators](https://www.staticgen.com/) (SSGs) has really opened my eyes to a new set of tools for building
...
There are [hundreds](https://github.com/topics/blog-engine) of blogging engines and SSGs to choose from. Each has its
...
for a test run, then determined what would be the best "_fit_" for my
...
-   **Markup converters are your friends** :clipboard:
    ...
    language? Really cool markup converters! Tools like [pandoc](https://pandoc.org/index.html) that convert your
...
### The tools for the job {#the-tools-for-the-job}

{{< figure src="/ox-hugo/stack.png" caption="Figure 1: The Art of Abstraction's picture stack" >}}

Here is a synopsis of the core dependencies for **The Art of Abstraction**

1.  [**Gatsby**](https://www.gatsbyjs.org/)

    _"Gatsby is a free and open source framework based on React that helps
    developers build blazing fast websites and apps"_ -- gatsbyjs.org

    Modern front-end development is **overwhelming** and **hard**. In order to have
    a website _feel_ and _behave_ like a modern web app, there are so many
    boxes that need to be checked. Gatsby easily checks many of those boxes and
    is the best shortcut I've found for doing _modern_ web development in an
    approachable way.

    Some amazing features that attracted me to Gatsby are

    -   _Configuration and setup is straightforward_
    -   _Integrates with the whole React ecosystem_
    -   _Great catalog of OSS plugins_
...
2.  [**MDX**](https://mdxjs.com/)
    ...
    _"MDX is an authorable format that lets you seamlessly write JSX in your
    ...
    content with components a blast."_ -- mdxjs.com
...
3.  [**Emacs org-mode**](https://orgmode.org/)
    ...
    _"Org mode is for keeping notes, maintaining TODO lists, planning projects,
    and authoring documents with a fast and effective plain-text system."_ --
    orgmode.org
    ...
    a [bunch](https://orgmode.org/manual/Exporting.html) number of formats, including markdown.
...
## In search of awe {#in-search-of-awe}

Humans love to tell stories, and if you believe in [Littlewood's Law](https://rationalwiki.org/wiki/Littlewood%27s%5Flaw), there are
